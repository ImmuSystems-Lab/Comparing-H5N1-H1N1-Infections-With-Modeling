...
#load parameters
sychain = np.genfromtxt('../data/fig 4/NSSD_min_ychainh1n1.csv', delimiter = ",", usecols = np.arange(0,10))[0,:]
print(np.shape(sychain))
sychain = np.genfromtxt('../data/fig 4/NSSD_min_ychainh5n1.csv', delimiter = ",", usecols = np.arange(0,10))[0,:]

ychainh1n1 = np.genfromtxt('../data/fig 4/AD_min_ychainh1n1.csv', delimiter = ",", usecols = np.arange(0,10))[0,:]
print(np.shape(ychainh1n1))
ychainh5n1 = np.genfromtxt('../data/fig 4/AD_min_ychainh5n1.csv', delimiter = ",", usecols = np.arange(0,10))[0,:]


def f4(u, t, p, ic):
    """3 state ODE model of Virus and IFN"""
